...
def get_score(model_id, text):
    ...
    headers = {
        ...
        'Authorization': 'Bearer bce-v3/ALTAK-dgXDfFQTQQ1AKLL24L2xE/ac47b2f74a95062a84a2b95561bbb88787a94ac3'
    }
    ...
    if 'choices' in json.loads(response.text).keys():
        url_result = json.loads(response.text)["choices"][0]["message"]["content"]
...
if __name__ == '__main__':
    ...
    for folder in folder_list:
        ...
        output_path = rf"D:\Sustech\course\CS490_Graduation_Thesis\work\results\baiduqianfan\v2"
        models = [
            ["DeepSeek-V3", "deepseek-v3"],  # [2，8192]
            ["DeepSeek-R1", "deepseek-r1"],  # [2，8192]
            ["DeepSeek-R1-Distill-Qwen-32B", "deepseek-r1-distill-qwen-32b"],  # [2，8192]
            ["DeepSeek-R1-Distill-Llama-70B", "deepseek-r1-distill-llama-70b"],  # [2，8192]
            ["DeepSeek-R1-Distill-Qianfan-Llama-70B", "deepseek-r1-distill-qianfan-llama-70b"],  # [2，8192]
            ["QwQ-32B", "qwq-32b"],  # [2，8192]
        ]
        print("save txt file")
        for model in models:
