...
def get_system():
    """
    获取system部分的提示词，即用户希望的评分标准
    """
    return ("你是一位大学教师教授，需要对学生提交的毕业设计论文进行评估。\n" +
...
if __name__ == '__main__':
    section_name = "题目"
    result_path = r"D:\Sustech\course\CS490_Graduation_Thesis\work\data-preprocessed\output.xlsx"
    # original
